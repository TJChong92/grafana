...
const step1TutorialTitle = 'S-Dash fundamentals';
...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to S-Dash',
    subheading: 'The steps below will guide you to quickly finish setting up your S-dash installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your S-dash installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'Set up and understand S-Dash if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
        href: 'https://syswelltiot.com/tutorials/s-dash-fundamentals',
        icon: 's-dash',
      ...
      },
      {
        ...
        icon: 'database',
        learnHref: 'https://syswelliot.com/docs/syswelliot/latest/features/datasources/add-a-data-source',
      ...
      },
      {
        ...
        icon: 'apps',
        href: 'dashboard/new',
        learnHref: 'https://syswelliot.com/docs/grafana/latest/guides/getting_started/#create-a-dashboard',
        check: async () => {
    ...
    cards: [
      {
        ...
        href: 'https://syswelliot.com/tutorials/create-users-and-teams',
        icon: 'users-alt',
        key: step2Key,
      ...
      },
      {
        ...
        learnHref: 'https://syswelliot.com/docs/grafana/latest/plugins/installation',
        href: 'plugins',
        icon: 'plug',
        check: async () => {
